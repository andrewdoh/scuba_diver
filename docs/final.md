...
From our analysis, we tested several different levels of $$\alpha$$, $$\gamma$$, and $$\epsilon$$ and found that the optimal levels to set the algorithm to are $$ \alpha = 0.1, 0.9 \geq \gamma \leq 1, \epsilon = 0.1$$. 
