...
saved_filename = "/Users/andrew/Desktop/Malmo-0.21.0-Mac-64bit/Sample_missions/WaterWorld4x4-sideways3rooms"
...
class UnderwaterAgent(object):
    def __init__(self, alpha=0.1, gamma=0.9, n=1):
        self.epsilon = 0.1
    ...
    def get_possible_actions(self, world_state):
        ...
        for k, v in possibilities.items():
            try:
                ...
                if grid[16 + v] == "water" or grid[16 + v] == "wooden_door" or grid[
                            16 + v] == "heavy_weighted_pressure_plate" or grid[16 + v] == "flowing_water":
        ...
        if grid[16 + 5] == "water" or grid[16 + 5] == "wooden_door" or grid[
                    16 + 5] == "heavy_weighted_pressure_plate" or grid[16 + 5] == "flowing_water":
    ...
    def act(self, world_state, agent_host, current_reward, episode):
        ...
        # creates a file and writes time spent per episode
        with open("actions.txt", "a") as actionfile:
            actionfile.write('{} {}\n'.format(episode, possible_actions[a]))
        time.sleep(0.25)
    ...
    def run(self, agent_host, episode):
        ...
        try:
            total_reward += self.act(world_state, agent_host, current_reward, episode)
        ...
        while world_state.is_mission_running:
            ...
            while True:
                world_state = agent_host.peekWorldState()
                if not world_state.is_mission_running:
                    with open("death.txt", "a") as deathfile:
                        # #1 == survived 0 == death

                        deathfile.write('{} {}\n'.format(episode, 'yes' if obs['IsAlive'] else 'no'))
...
for i in range(num_repeats):
    ...
    cumu_reward = agent.run(agent_host, i)
    ...
    with open("time_alive.txt", "a") as myfile:
        if cumu_reward is not None:
