...
saved_filename = "/Users/andrew/Desktop/Malmo-0.21.0-Mac-64bit/Sample_missions/WaterWorld4x4-2ffloors"
    ...
    def act(self, world_state, agent_host, current_reward, episode):
        ...
        if self.training and self.prev_s is not None and self.prev_a is not None:
            ...
            self.q1_table[self.prev_s][self.prev_a] = \
                old_q_1 + self.alpha * (current_reward + self.gamma * max(self.q1_table[curr_state]) - old_q_1)
    ...
    def choose_action(self, curr_state, possible_actions):
        ...
        if rnd < self.epsilon:
            ...
            for action in range(len(possible_actions)):
                ...
                if self.q1_table[curr_state][action] == m:
                    l.append(action)
